...
struct CanonicalLibraryObjectTests {
    ...
    @Test func manifestDecodesOldPayloadAndHashesNewLibraryObjectsDeterministically() throws {
        ...
        {
          "schemaVersion": 1,
          "node": {"nodeID": "old-mac", "platform": "Mac", "capabilities": []},
          "generatedAt": {"date": 0},
          "objects": []
        }
        """
    ...
    @Test func macLibraryAdapterProjectsFoldersStudyItemsStandaloneNotesAndTombstones() {
        ...
        let adapter = MacCanonicalLibraryAdapter()
