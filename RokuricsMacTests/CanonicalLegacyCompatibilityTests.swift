...
struct CanonicalLegacyCompatibilityTests {
    @Test func compatibilityMatrixProvesEveryDomainOnMac() {
    ...
    @Test func matrixReportsCanonicalOnlyRequiredFieldAsBlockerOnMac() {
    ...
    @Test func roundtripCompatibilityForEveryDomainOnMac() throws {
    ...
    @Test func crashRestartSafetyForEveryDomainAndCheckpointOnMac() {
    ...
    @Test func switchBackRuntimeHarnessComparesOldAndCanonicalStateOnMac() {
        var harness = CanonicalLegacySwitchBackHarness()
    ...
    @Test func realisticRootHarnessProvesSwitchBackWithoutLegacyRetirementOnMac() throws {
