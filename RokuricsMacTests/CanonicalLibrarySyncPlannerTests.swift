...
struct CanonicalLibrarySyncPlannerTests {
    @Test func libraryMetadataV852HashSchemaExcludesResourceTokensOnMac() {
        let noteA = studyObject(resources: ["notes/a.md"])
        let noteB = studyObject(resources: ["notes/b.md"])
