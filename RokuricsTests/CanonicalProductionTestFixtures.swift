...
enum CanonicalProductionTestFixtures {
    ...
    static func recording(
        ...
        return CanonicalRecordingObject(objectID: id, nodeID: "iphone-01", metadata: metadata, artifacts: artifacts)
    }
    ...
    static func snapshot(
        ...
        IPhoneCanonicalProductionSnapshotAdapter().buildSnapshot(
            from: IPhoneCanonicalProductionSnapshotInput(
                node: node,
