...
struct CanonicalNoCommitStagingRootTests {
    @Test func defaultCleanupRemovesCurrentRootAndRedactsEvidence() throws {
        let rootURL = Self.makeScratchRoot("NoCommitDefaultCleanup")
    ...
    @Test func cleanupRefusesProductionRootAndProductionChild() throws {
        let productionRoot = Self.makeScratchRoot("NoCommitProductionRoot")
    ...
    @Test func retentionPolicyPurgesOldRootsByCountAndBytes() throws {
        let parent = Self.makeScratchRoot("NoCommitRetention")
    ...
    @Test func evidenceReportSummarizesCountsWithoutPaths() throws {
        ...
        let staging = CanonicalRecordingMetadataNoCommitStagingResult(
            ...
            stagedLogicalPathToken: "recording-metadata/iphone-recording-01-action.json",
            payloadByteCount: 24,
    ...
    @Test func iphoneExecutorCleansUpAfterStagingFailure() throws {
        let fileRoot = Self.makeScratchRoot("NoCommitFailureCleanup").appendingPathComponent("not-a-directory")
        ...
        let executor = IPhoneRecordingMetadataNoCommitExecutor(stagingRootURL: fileRoot)
