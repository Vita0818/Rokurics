...
struct IPhoneLibraryMetadataNoCommitExecutor: CanonicalLibraryMetadataNoCommitExecutor {
    ...
    private nonisolated func stage(
        ...
        do {
            ...
            return CanonicalLibraryMetadataNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                reason: "iphoneLibraryMetadataNoCommitWouldUseMetadataManifestBridge"
            )
        } catch {
            ...
            return CanonicalLibraryMetadataNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                failure: .stagingFailed,
                reason: "iphoneLibraryMetadataNoCommitStagingFailed"
            )
        }
    }
