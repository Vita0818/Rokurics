...
actor IPhoneLibraryMetadataCutoverExecutor: CanonicalLibraryMetadataCutoverExecutor {
    ...
    init(
        applyPort: any CanonicalProductionApplyPort = IPhoneLibraryMetadataRealApplyPort(),
    ...
    func commitLibraryMetadata(
        ...
        guard !applyPort.isDryRunOnly else {
            return .failure(candidate: candidate, kind: .applyFailureBeforeCommit, reason: "iphoneLibraryMetadataCommitRequiresExplicitTestRootApplyPort")
        }
        ...
        do {
            ...
            return .failure(
                ...
                reason: "iphoneLibraryMetadataApplyPortFailed"
            )
        }
    ...
    func rollbackLibraryMetadata(
        ...
        if reason == .applyFailureBeforeCommit || applyPort.isDryRunOnly {
            ...
            return CanonicalLibraryMetadataRollbackExecutionResult(
                checkpointID: candidate.effectiveRollbackCheckpointID,
                succeeded: true,
                reason: "iphoneLibraryMetadataRollbackNoOp",
        ...
        guard checkpointIDs.contains(candidate.effectiveRollbackCheckpointID) else {
            ...
            return CanonicalLibraryMetadataRollbackExecutionResult(
                ...
                succeeded: false,
                fatal: true,
                reason: "iphoneLibraryMetadataRollbackCheckpointMissing"
            )
        }
        let action = CanonicalRollbackAction(
            actionID: "iphone-library-metadata-rollback-\(candidate.action.actionID)",
        ...
        do {
            ...
            return CanonicalLibraryMetadataRollbackExecutionResult(
                ...
                reason: result.succeeded ? "iphoneLibraryMetadataRollbackCompleted" : "iphoneLibraryMetadataRollbackFailed",
            ...
            return CanonicalLibraryMetadataRollbackExecutionResult(
                ...
                succeeded: false,
                fatal: true,
                reason: "iphoneLibraryMetadataRollbackFailed"
            )
        }
    }
