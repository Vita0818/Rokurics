//
//  IPhoneRecordingMetadataReadSideSeam.swift
//  Rokurics
//
...
struct IPhoneRecordingMetadataReadSideSeam {
    ...
    ) -> IPhoneRecordingMetadataReadSideSeam {
        IPhoneRecordingMetadataReadSideSeam(configuration: result.effectiveConfiguration.readRuntimeConfiguration)
    }
    ...
    nonisolated func read(
        ...
        let legacyCanonicalManifest = legacyManifest.map(IPhoneCanonicalReadRuntimeAdapter.makeCanonicalManifest)
        return read(
