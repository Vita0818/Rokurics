...
nonisolated struct MacCanonicalProductionSnapshotInput: Sendable {
...
nonisolated struct MacCanonicalProductionSnapshotAdapter {
    nonisolated init() {}

    nonisolated func buildSnapshot(from input: MacCanonicalProductionSnapshotInput) -> CanonicalProductionSnapshot {
