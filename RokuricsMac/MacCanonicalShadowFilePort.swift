...
actor MacCanonicalShadowFilePort: CanonicalProductionFilePort {
    ...
    private let wrapped: MacCanonicalProductionFilePort
    ...
    init(binding: CanonicalShadowRootBinding, fileManager: FileManager = .default) throws {
        ...
        self.wrapped = MacCanonicalProductionFilePort(
            testRootURL: rootURL,
    ...
    func projectWrite(_ intent: CanonicalFileWriteIntent) async throws -> CanonicalProductionWriteIntentProjection {
        ...
        projection.reason = "macShadowRootWriteAvailable"
