...
struct MacTombstoneConflictNoCommitExecutor: CanonicalTombstoneConflictNoCommitExecutor {
    ...
    private nonisolated func stage(
        ...
        do {
            ...
            return CanonicalTombstoneConflictNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                reason: "macTombstoneConflictNoCommitSuppressedProductionCommit"
            )
        } catch {
            ...
            return CanonicalTombstoneConflictNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                failure: .stagingFailed,
                reason: "macTombstoneConflictNoCommitStagingFailed"
            )
        }
    }
