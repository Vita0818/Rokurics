...
enum RecordingAudioUploadDecisionEvaluator {
    static func evaluateRecordingAudioUploadDecision(
        ...
        // A retry may resume a durable job created by an earlier explicit
        // upload-button tap. Retry itself still cannot create a new job.
...
nonisolated enum LocalNetworkSyncArtifactKind: String, Codable, Equatable, Sendable {
    case metadataJSON
    case receiveJSON
    ...
    nonisolated var isAutoDownloadAllowed: Bool {
        switch self {
    ...
    nonisolated var participatesInObjectReconciliation: Bool {
        switch self {
...
nonisolated enum LocalNetworkSyncArtifactAvailability: String, Codable, Equatable, Sendable {
    case local
...
nonisolated struct LocalNetworkSyncFolderEntry: Codable, Equatable, Identifiable {
...
nonisolated struct LocalNetworkSyncStudyItemEntry: Codable, Equatable, Identifiable {
...
nonisolated struct LocalNetworkSyncArtifactEntry: Codable, Equatable, Identifiable {
    ...
    private func suppressUploadsForPeerAvailableAudio(
        ...
        for action in plan.uploadRecordingAudioActions {
            ...
            if decision.shouldCreateUploadJob {
                ...
                // A sync plan may describe missing content, but only an
                // explicit Upload action may turn that suggestion into a job.
...
nonisolated enum LocalNetworkSyncArtifactID {
    ...
    nonisolated static func validate(_ artifactID: String) throws {
    ...
    nonisolated static func validateLogicalPathToken(_ token: String) throws {
    ...
    nonisolated static func validateLogicalPathToken(_ token: String, for kind: LocalNetworkSyncArtifactKind) throws {
...
nonisolated enum LocalNetworkSyncArtifactFileService {
    nonisolated static func safeFileURL(rootURL: URL, logicalPathToken: String, fileManager: FileManager = .default) throws -> URL {
    ...
    nonisolated static func safeFileURL(rootURL: URL, logicalPathToken: String, kind: LocalNetworkSyncArtifactKind, fileManager: FileManager = .default) throws -> URL {
    ...
    nonisolated static func metadata(for url: URL, fileManager: FileManager = .default) -> (size: Int64, updatedAt: Date)? {
