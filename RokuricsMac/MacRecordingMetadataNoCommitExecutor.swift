...
struct MacRecordingMetadataNoCommitExecutor: CanonicalRecordingMetadataNoCommitExecutor {
    ...
    private nonisolated func stage(
        ...
        do {
            ...
            return CanonicalRecordingMetadataNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                reason: candidate.canonicalDirection == .send ? "macNoCommitWouldSend" : "macNoCommitWouldApply"
            )
        } catch {
            ...
            return CanonicalRecordingMetadataNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                failure: .stagingFailed,
                reason: "macNoCommitStagingFailed"
            )
        }
    }
