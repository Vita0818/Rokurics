...
actor MacGeneratedArtifactCutoverExecutor: CanonicalGeneratedArtifactCutoverExecutor {
    ...
    init(
        applyPort: any CanonicalProductionApplyPort = MacGeneratedArtifactRealApplyPort(),
    ...
    func commitGeneratedArtifact(
        ...
        guard !applyPort.isDryRunOnly else {
            return .failure(candidate: candidate, kind: .applyFailureBeforeCommit, reason: "macGeneratedArtifactCommitRequiresExplicitTestRootApplyPort")
        }
        ...
        do {
            ...
            return .failure(
                ...
                reason: "macGeneratedArtifactApplyPortFailed"
            )
        }
    ...
    func rollbackGeneratedArtifact(
        ...
        if reason == .applyFailureBeforeCommit
            ...
            return CanonicalGeneratedArtifactRollbackExecutionResult(
                checkpointID: candidate.effectiveRollbackCheckpointID,
                succeeded: true,
                reason: "macGeneratedArtifactRollbackNoOp",
        ...
        guard checkpointIDs.contains(candidate.effectiveRollbackCheckpointID) else {
            ...
            return CanonicalGeneratedArtifactRollbackExecutionResult(
                ...
                succeeded: false,
                fatal: true,
                reason: "macGeneratedArtifactRollbackCheckpointMissing"
            )
        }
        let action = CanonicalRollbackAction(
            actionID: "mac-generated-artifact-rollback-\(candidate.action.actionID)",
        ...
        do {
            ...
            return CanonicalGeneratedArtifactRollbackExecutionResult(
                ...
                reason: result.succeeded ? "macGeneratedArtifactRollbackCompleted" : "macGeneratedArtifactRollbackFailed",
            ...
            return CanonicalGeneratedArtifactRollbackExecutionResult(
                ...
                succeeded: false,
                fatal: true,
                reason: "macGeneratedArtifactRollbackFailed"
            )
        }
    }
