...
struct MacGeneratedArtifactNoCommitExecutor: CanonicalGeneratedArtifactNoCommitExecutor {
    ...
    private nonisolated func stage(
        ...
        do {
            ...
            return CanonicalGeneratedArtifactNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                reason: "macGeneratedArtifactNoCommitWouldRequestAndApply"
            )
        } catch {
            ...
            return CanonicalGeneratedArtifactNoCommitStagingResult(
                ...
                cleanupEvidence: CanonicalNoCommitCleanupEvidence(result: cleanup),
                failure: .stagingFailed,
                reason: "macGeneratedArtifactNoCommitStagingFailed"
            )
        }
    }
