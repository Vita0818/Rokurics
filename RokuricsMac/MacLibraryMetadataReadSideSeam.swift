...
struct MacLibraryMetadataReadSideSeam {
    ...
    func evaluate(
        ...
        if let legacyManifest {
            let objects = MacCanonicalLibraryAdapter().makeLibraryObjects(from: legacyManifest)
    ...
    func observeReadSource(
        ...
        observationWindowID: String = "macLibraryMetadataReadSourceObservation",
        trigger: CanonicalSyncPlanTrigger,
        syncRunID: String?
